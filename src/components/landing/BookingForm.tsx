              ...
              <CardContent>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-4 pt-4 border-t border-border/50">
                    ...
                    {isAirportTransfer && (
                      <div
                        className="space-y-2 p-4 bg-primary/5 rounded-lg border border-primary/10">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full hover:bg-primary/90 py-6 text-lg bg-amber-400"
            ...
            <Card className="border-border/50 sticky top-24">
              ...
              <CardContent className="space-y-6">
                ...
                <a
                  ...
                  className="flex items-start gap-4 p-4 rounded-lg bg-secondary/50 hover:bg-secondary transition-colors">
                  <div
                    className="w-10 h-10 rounded-lg bg-green-500/10 flex items-center justify-center flex-shrink-0">
                    <svg
