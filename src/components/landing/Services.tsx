...
const services = [
  {
    ...
    description: "Seamless pickup and drop-off between El Nido Airport and your accomodation. Comfortable vehicles, professional drivers, and flight tracking included.",
  ...
  },
  {
    ...
    features: ["Lio Beach, Nacpan Beach, Vanilla Beach", "Tour guide services may be requested for an extra fee.", "Prices may vary for additional destinations."],
    price: "From ₱3,499",
    ...
    <section id="services" className="py-20 md:py-32 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span
            className="font-medium text-xs sm:text-sm tracking-wider uppercase mb-3 sm:mb-4 block text-red-600">
            Our Services
          </span>
          <h2
