    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Headline */}
          <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight h-[182px]">
          ...
          <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto leading-relaxed">
            Trusted airport transfers, breathtaking island tours, and reliable
            vehicle rentals across Palawan. Travel with the family that knows
            these roads by heart.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              ...
              size="lg"
              className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg font-semibold shadow-lg shadow-primary/25"
            >
              Book Your Ride
            </Button>
            <Button
          ...
          {/* Trust Indicators */}
          <div className="mt-12 flex flex-wrap items-center justify-center gap-6 md:gap-12 text-white/70">
